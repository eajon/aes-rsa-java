...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        params.put("bankBusinessId", UUID.randomUUID().toString());
        params.put("bankCode", "zsyh");
        params.put("bankName", "浙商银行杭州支行");
        params.put("payerName", "Jack");
        params.put("payerCountryCode", "USA");
        params.put("payerCountryName", "美国");
        params.put("amount", "20000");
        params.put("curr", "USD");
        params.put("isPrivate", "0");
        params.put("isPrivate", "0");

        ZfApi.sendReceiptNotice(params,"http://127.0.0.1:8888",clientPrivateKey,clientPublicKey,serverPublicKey);
//        client(params);
//        server();
    }

    public static void client(TreeMap<String, String> params) throws Exception {
        // 生成RSA签名
